...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    function generateHousingAdvice(level) {
        ...
        if (level === "bunny") {
            ...
            advice = "<strong><i class='fa-regular fa-face-smile'></i> Friend housing advice:</strong> <br>Your housing expenses are rather high. You're going to need to look into ways to reduce these.<br>Maybe consider renting some of your un-used space? <br>Here are some links to <a href='https://luckyattitude.co.uk/clever-ways-to-reduce-housing-expenses/' target='_blank'>reduce housing expenses</a> or <a href='https://yourfinancialpharmacist.com/7-ways-to-reduce-your-monthly-housing-costs/' target='_blank'>reduce monthly housing costs</a>.";
        } else if (level === "sociopath") {
            advice = "<strong><i class='fa-solid fa-cloud-bolt'></i> Sociopath housing advice:</strong> <br><a href='https://www.quirkycampers.com/uk/quirky-van-conversions/ ' target='_blank'>Converting a van</a> or moving in a whole load of lodgers are looking like strong options for you right now.";
        }
        return advice;
    }
    ...
    function generateTransportationAdvice(level) {
        let advice = "";
        if (level === "bunny") {
            advice = "<strong><i class='fa-solid fa-carrot'></i> Bunny transportation advice:</strong> <br>Your transportation expenses are higher than recommended. <br>Consider using public transportation or <a href='https://liftshare.com/uk' target='_blank'>carpooling</a> to save money.";
        } else if (level === "friend") {
            advice = "<strong><i class='fa-regular fa-face-smile'></i> Friend transportation advice:</strong> <br>Your transportation costs are a bit high. <br>Look for ways to reduce these expenses, like using a more fuel-efficient vehicle or biking for short trips.<br>Maybe see if you qualify for any <a href='https://www.mybaggage.com/blog/best-cycle-to-work-schemes-around-the-world/' target='_blank'>cycle to work schemes</a>";
        } else if (level === "sociopath") {
    ...
    function generateLoanAdvice(level) {
        let advice = "";
        if (level === "bunny") {
            advice = "<strong><i class='fa-solid fa-carrot'></i> Bunny loan advice:</strong> <br>Consider applying for a loan with lower interest rates to reduce your overall debt burden. <br>It's always hard when you're trying to clear debt, but <a href='https://www.moneysupermarket.com/loans/debt-consolidation-loan/' target='_blank'>help is available</a>.";
        } else if (level === "friend") {
            advice = "<strong><i class='fa-regular fa-face-smile'></i> Friend loan advice:</strong> <br>Your current loans may have high interest rates. <br>Look into refinancing options to <a href='https://www.moneysupermarket.com/loans/debt-consolidation-loan/' target='_blank'>lower your monthly payments</a>.";
        } else if (level === "sociopath") {
            advice = "<strong><i class='fa-solid fa-cloud-bolt'></i> Sociopath loan advice:</strong> <br>What on earth did you need all those loans for?! <br>You're on the brink potential financial catastrophe. <br>Consider selling a kidney, or at very least any of your un-used junk to reduce the debts as <a href='https://www.horizonfcu.org/5-ways-to-pay-off-a-loan-early/' target='_blank'>as fast as possible</a>!";
        }
        return advice;
    }
    ...
    function generateGroceriesAdvice(level) {
        ...
        if (level === "bunny") {
            ...
            advice = "<strong><i class='fa-regular fa-face-smile'></i> Friend groceries advice: </strong> <br>You're currently spending a larger than advised proportion of your income on groceries. <br>You need to develop strategies to save money: here are some sites with suggestions for <a href='https://www.moneysavingexpert.com/shopping/cheap-supermarket-shopping/' target='_blank'>cheaper shopping</a>, <a href='https://www.unbiased.co.uk/discover/personal-finance/budgeting/10-of-the-best-ways-to-save-money-on-your-food-shopping' target='_blank'>saving money on shopping</a>, and <a href='https://www.savethestudent.org/save-money/food-drink/ways-to-save-money-on-food.html' target='_blank'>saving money on food</a>.";
        } else if (level === "sociopath") {
    ...
    function generateHealthcareAdvice(level) {
        ...
        if (level === "bunny") {
            ...
            advice = "<strong><i class='fa-regular fa-face-smile'></i> Friend healthcare spending advice:</strong> <br>You should look for ways to reduce the spending here. <br>Shop around for insurance, consider changing suppliers and maybe add some more <a href='https://www.healthline.com/health/beauty-skin-care/add-these-8-foods-to-your-diet-for-healthy-hair-skin-and-nails' target='_blank'>health foods</a>.";
        } else if (level === "sociopath") {
    ...
    function generateBillsAdvice(level) {
        ...
        if (level === "bunny") {
            ...
            advice = "<strong><i class='fa-regular fa-face-smile'></i> Friend bills advice:</strong> <br><a href='https://financebuzz.com/easy-ways-to-lower-your-bills-new' target='_blank'>Use less</a> water, electricity and gas through trying some tips. <br>Also shop around for the cheapest suppliers.<br>This <a href='https://www.rd.com/list/lower-bills/' target='_blank'>link</a> might help";
        } else if (level === "sociopath") {
    ...
    function generateChildrenAdvice(level) {
        ...
        if (level === "bunny") {
            ...
            advice = "<strong><i class='fa-regular fa-face-smile'></i> Friend children spending advice:</strong> <br>Shop around for cheaper options for childcare and <a href='https://www.todaysparent.com/family/activities/fun-things-to-do-with-your-kids/' target='_blank'>activities</a>. <br>There are a number of websites to <a href='https://www.mykidstime.com/things-to-do/101-things-to-do-with-kids-that-will-cost-nothing-but-time/' target='_blank'>help</a> you with this.";
        } else if (level === "sociopath") {
    ...
    function generateSavingsAdvice(level) {
        ...
        if (level === "bunny") {
            ...
            advice = "<strong><i class='fa-regular fa-face-smile'></i> Friend savings advice:</strong> <br>Do some research and find some good regular savers, so you don't have to remember to move your money each month. <br>It is recommended that around 20% of your monthly income should be put into savings/pensions to secure future financial security.<br>Here is some advice for <a href='https://www.nerdwallet.com/article/finance/how-to-save-money' target='_blank'>how</a> and <a href='https://www.forbes.com/advisor/banking/places-to-save-money/' target='_blank'>where</a> to save money, and how to do it <a href='https://n26.com/en-eu/blog/how-to-save-money-fast' target='_blank'>quickly</a>. <br>Good luck!";
        } else if (level === "sociopath") {
    ...
    function generateHobbiesAdvice(level) {
        ...
        if (level === "bunny") {
            ...
            advice = "<strong><i class='fa-regular fa-face-smile'></i> Friend hobbies advice:</strong> <br>There will be ways to reduce this figure if you want to. <br>Shop around for things like gym memberships or consider free meet-ups like <a href='https://www.parkrun.com/' target='_blank'>ParkRun</a>.<br>Craft and hobby supplies can often be sourced <a href='https://www.preloved.co.uk/classifieds/hobbies/arts-crafts' target='_blank'>pre-loved</a>, which is a great way to save pennies.";
        } else if (level === "sociopath") {
